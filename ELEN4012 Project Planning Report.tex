...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\abstract{The purpose of this document is to outline the project plan to implement an Internet of Things (IoT) based smart parking system to alert car drivers of available parking bays. The project plan uses boost converters, Adruino nano development boards, ESP-8266 development boards, ultrasonic sensors, Radio Frequency (RF) communication, ThingSpeak cloud IoT platform and  Android framework in an attempt to give the project the best chance of succeeding. Testing methodologies have been outlined to quantify the system's operation under which it would be considered successful. Background and contextualisation is provided and analysed with emphasis on the hardware, communication techologies, deployment methodlogies, data management and data presentation components. This analysis allowed for an appropriate and efficient project design to be proposed by considering all possible design components and possible flaws that could be encountered. The project, from design to demonstration, should take 6 weeks.}
	
\keywords{Internet of Things, Arduino nano, ESP-8266, Ultrasonic sensor, Radio Frequency, ThingSpeak, MQTT, HTTP, RESTful API, Android, Mobile application, GUI, Power consumption, Mesh network.}
