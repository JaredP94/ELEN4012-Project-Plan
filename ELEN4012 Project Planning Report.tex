...
\section{PROJECT MANAGEMENT}
	...
	Figure~\ref{fig:timeline} demonstrates the projected project timeline and the phase progression or the project.
	
	\begin{figure}
		\centering
		\includegraphics[width=1\columnwidth]{timeline.png}
